...
return {
  -- Install treesitter parsers.
  {
    ...
    opts = function(_, opts)
      vim.list_extend(opts.ensure_installed, { "c_sharp", "gdscript" })
    end,
  },
  ...
  -- Setup LSPs
  {
    ...
    opts = {
      servers = {
        ...
        -- c# lsp
        omnisharp = {
          -- TODO: these require telescope I believe, and they don't work when using fzf-lua
          keys = {
            {
              "gd",
            ...
            { "gr", "<cmd>lua require('omnisharp_extended').lsp_references()<CR>", desc = "References (omnisharp)" },
            {
              "gr",
              "<cmd>lua require('omnisharp_extended').lsp_implementations()<CR>",
